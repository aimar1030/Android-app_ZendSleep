 ...
 */
public class MySlidingDrawer extends ViewGroup implements OnTouchListener {
	...
	public MySlidingDrawer(Context context, AttributeSet attrs, int defStyle) {
		...
		int orientation = a.getInt(R.styleable.MySlidingDrawer_orientation,
		...
		mHandlePosition = a.getInt(R.styleable.MySlidingDrawer_handlePosition,
				1);

		position = a.getInt(R.styleable.MySlidingDrawer_position, 1);
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		if (mVertical) {
			...
			if (mHandlePosition == 0) {
				childLeft = position * childWidth;
				childRight = childLeft + childWidth;
			}

			else if (mHandlePosition == 1) {
				childLeft = l + width / 3;
				childRight = childLeft + width / 3;
			}

			else if (mHandlePosition == 2) {
		...
		handle.layout(childLeft, childTop, childRight,
