...
public abstract class EcoGalleryAdapterView<T extends Adapter> extends
		ViewGroup {
	...
	public interface OnItemClickListener {
		 ...
		 */
		void onItemClick(EcoGalleryAdapterView<?> parent, View view,
	...
	public interface OnItemLongClickListener {
		 ...
		 */
		boolean onItemLongClick(EcoGalleryAdapterView<?> parent, View view,
				int position, long id);
	}
	...
	public interface OnItemSelectedListener {
		 ...
		 */
		void onItemSelected(EcoGalleryAdapterView<?> parent, View view,
				int position, long id);
	...
	class AdapterDataSetObserver extends DataSetObserver {
		...
		public void onInvalidated() {
			...
			if (EcoGalleryAdapterView.this.getAdapter().hasStableIds()) {
				...
				mInstanceState = EcoGalleryAdapterView.this
						.onSaveInstanceState();
			}
